    ...
    return(<div className="flex px-[20rem] items-end justify-between">
       ...
       <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="flex gap-5">
            <button className="rounded-md bg-white px-5 py-3 text-[1.4rem] hover:bg-gray-300 cursor-pointer">Message</button>
            <button className="rounded-md bg-white px-5 py-3 text-[1.4rem] hover:bg-gray-300 cursor-pointer">Call</button>
        </div>
       </div>
